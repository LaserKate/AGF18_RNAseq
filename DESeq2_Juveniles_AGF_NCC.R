...
ktable=makeDeltaRanksTable(list("D1"=D,"SS"=SS,"SED"=SED,"Larval Response"=Larva_HA, "Larval Tolerance"=Larva_Tolerance))
#remove nuclear structure because only has 4 genes and values are outliers
ktable <- ktable[-c(6), ]
...
pairs(ktable, lower.panel = panel.smooth, upper.panel = panel.cor)
corrPlot(x="D1",y="SS",ktable) #not significant
corrPlot(x="D1",y="SED",ktable) #not significant
corrPlot(x="SS",y="SED",ktable) #very significant
corrPlot(x="SS",y="Larval Response",ktable) #significant
corrPlot(x="SS",y="Larval Tolerance",ktable) #significant
corrPlot(x="D1",y="Larval Response",ktable) #not significant
corrPlot(x="D1",y="Larval Tolerance",ktable) #not significant
corrPlot(x="SED",y="Larval Response",ktable) #not significant
corrPlot(x="SED",y="Larval Tolerance",ktable) #not significant
corrPlot(x="Larval Response",y="Larval Tolerance",ktable) #not significant
